...
CREATE VIEW view_total_revenue_1997 AS
...
CREATE VIEW view_acumulative_revenue AS
...
CREATE VIEW view_total_revenue_per_customer AS
        SELECT  
            c.contact_name,
...
CREATE VIEW view_total_revenue_per_customer_group AS
